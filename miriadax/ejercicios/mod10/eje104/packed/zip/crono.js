$(function(){ 
	...
	{	
		...
		$('#cuerpo').on('swipe', function(){if (!t) {localStorage.c="0.0";localStorage.d="";mostrar();r.html("0.0");}});
	}
	else
	{
  		// No es un dispositivo táctil.
  	 	$('#cambiar').on('click', cambiar);
		$('#inicializar').on('click', function(){if (!t) {localStorage.c="0.0";localStorage.d="";mostrar();r.html("0.0");}});
	} 
